...
export default function RelationalComparisonPage() {
  ...
  return (
    <div className="flex flex-col w-full gap-5 p-5 bg-white rounded-xl shadow-sm">
      <h2 className="text-2xl font-bold text-center">Relational Comparison</h2>
      <div className="space-y-3 p-4 bg-gray-200 rounded-lg shadow-sm">
        <div className="flex flex-row items-center justify-between">
          <div className="flex flex-col gap-0.5">
            <h2 className="text-xl font-semibold">Relational Comparison Option</h2>
